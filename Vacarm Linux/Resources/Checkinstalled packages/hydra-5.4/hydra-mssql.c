...
int
start_mssql(int s, unsigned long int ip, int port, unsigned char options, char *miscptr, FILE * fp)
{
  char *empty = "";
...
void
service_mssql(unsigned long int ip, int sp, unsigned char options, char *miscptr, FILE * fp, int port)
{
